...
export class MimicoPortaReino extends Phaser.Physics.Arcade.Sprite implements InimigoReino {
    ...
    constructor(cena:Phaser.Scene,x:number,y:number,private readonly alvo:Phaser.Physics.Arcade.Sprite,bonusVida=0){super(cena,x,y,'reino-mimico-porta',0);cena.add.existing(this);cena.physics.add.existing(this);this.vida=5+bonusVida;this.setScale(.21).setDepth(9);(this.body as Phaser.Physics.Arcade.Body).setSize(245,430).setOffset(82,233).setMaxVelocity(185,650);}
