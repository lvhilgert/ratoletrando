...
export interface EstadoReino {moedas:number;gemas:number;pergaminhos:number;melhorMoedas:number;portasAbertas:number;checkpointX:number;faseAtual:number;conclusoes:number;equipamentos:string[];equipado:EquipadoReino;assistencia:boolean;dificuldade:'tranquilo'|'normal'|'aventura';skin:number;invencivel:boolean;faixaSoma:FaixaReino;faixaQuantidade:FaixaReino}
const CHAVE='educapp:reino-portas:v2';
const INICIAL:EstadoReino={moedas:0,gemas:0,pergaminhos:0,melhorMoedas:0,portasAbertas:0,checkpointX:120,faseAtual:0,conclusoes:0,equipamentos:['espada'],equipado:{arma:'espada'},assistencia:true,dificuldade:'normal',skin:0xffffff,invencivel:false,faixaSoma:{minimo:0,maximo:50},faixaQuantidade:{minimo:3,maximo:9}};
