...
export class Carregamento extends Phaser.Scene {
    ...
    preload(): void {
        ...
        this.load.spritesheet('rato', 'assets/ratoletrando/jogo/rato-sprites-alinhado.png', { frameWidth: 256, frameHeight: 256, endFrame: 11 });
        this.load.spritesheet('gato', 'assets/ratoletrando/jogo/gato-sprites-alinhado.png', { frameWidth: 256, frameHeight: 256, endFrame: 11 });
        this.load.spritesheet('natureza', 'assets/ratoletrando/jogo/natureza.png', { frameWidth: 627, frameHeight: 627 });
        this.load.image('azulejo-amarelo', 'assets/ratoletrando/jogo/azulejo-amarelo.png');
    ...
    create(): void {
        ...
        const animar=(personagem:string) => {
            ['frente','costas','direita','esquerda'].forEach((direcao,linha)=>this.anims.create({
                ...
                frames:this.anims.generateFrameNumbers(personagem,{start:linha*3,end:linha*3+2}),
                frameRate:8,
                repeat:-1,
                yoyo:false
            }));
