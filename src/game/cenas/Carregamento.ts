...
export class Carregamento extends Phaser.Scene {
    ...
    preload(): void {
        ...
        ['espada-rapida','lanca','martelo','arco'].forEach(tipo=>this.load.spritesheet(`reino-cavaleiro-${tipo}`,`assets/reino-portas/reino-cavaleiro-${tipo}.png`,{frameWidth:200,frameHeight:667,endFrame:9}));
